...
function Word({ children, ...props }) {
  ...
  const fontProps = { font: interBold, fontSize: 2.5, letterSpacing: -0.05, lineHeight: 1, 'material-toneMapped': false }
  const ref = useRef()
    ...
    */
    ...
    for (let i = 1; i < count + 1; i++){
      ...
      for (let j = 0; j < count; j++) {
        ...
        temp.push([new THREE.Vector3().setFromSphericalCoords(radius, phiSpan * i, thetaSpan * j), randomWord()])
      }
    }
    return temp
  }, [count, radius])
